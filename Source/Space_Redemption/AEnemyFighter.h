...
public:
	...
	UFUNCTION(BlueprintCallable, category = "Initialization")
		void SetStategy(AActor* target, float Speed = 1000, FRotator LastEvasionDeltaRotator = FRotator(0.0f,0.0f,0.0f), float EncounterRange = 2000.0f, float EvasionRange = 1000.0f, float EvasionTime = 1.0f);
};